...
namespace PostSharp.Samples.WeakEvent
{
    ...
    /// Client classes must have the <see cref="WeakEventClientAttribute"/> aspect, otherwise an exception will be thrown at runtime (if <see cref="AllowStrongReferences"/> is set to <c>true</c>), or a
    ...
    public sealed class WeakEventAttribute : EventInterceptionAspect, IInstanceScopedAspect
    {
        ...
        /// </summary>
        /// <param name="allowStrongReferences">Determines whether the current aspect is allowed to create a strong reference if the client does not have
        /// the <see cref="WeakEventClientAttribute"/> aspect. The default value is <c>false</c>.</param>
        ...
        /// <summary>
        /// Creates an instance of the aspect for a specific instance of the target class (when the target event is not static). A call of this method is followed by a call of RuntimeInitializeInstance.
        /// </summary>
