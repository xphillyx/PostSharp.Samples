...
{
    /// <summary>
    /// Exposes the global properties of the security framework in the current context. This interface is exposed on the <see cref="SecurityContext.Current"/> property.
    /// </summary>
