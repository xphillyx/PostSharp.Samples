...
namespace PostSharp.Samples.Authorization.RoleBased
{
    ...
    {
        readonly Dictionary<Type, List<Assignment>> rolePermissionAssignments = new Dictionary<Type, List<Assignment>>();


        /// <summary>
        /// Grants or revokes a permission to or from members of a role for a given type of entity.
        /// </summary>
        /// <param name="entitytype">Base type of entities for which the permission is granted. To assign the permission to all entity types, pass <c>typeof(object)</c>.</param>
        ...
        public void AddRolePermissionAssignment(Type entitytype, IPermission permission, IRole role, PermissionAction action)
        {
