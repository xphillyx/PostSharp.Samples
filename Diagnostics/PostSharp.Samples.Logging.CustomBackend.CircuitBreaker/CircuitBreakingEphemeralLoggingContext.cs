...
{
    // Other derived types: FrigateEphemeralContext
    ...
    {
        public CircuitBreakingEphemeralLoggingContext(LoggingBackend backend, ThreadLoggingContext threadContext) : base(backend, threadContext)
        {
        }
