...
{
    /// <summary>
    /// Aspect that, when applied to an instance field or property of a <see cref="Page"/> or <see cref="Control"/>, causes this field or property to be persisted in the view state state.
    /// </summary>
    [PSerializable]
    ...
    public sealed class ViewStateAttribute : LocationInterceptionAspect, IInstanceScopedAspect
    {
        ...
        /// <returns><c>true</c> if <paramref name="locationInfo"/> is a valid target for the current aspect, otherwise <c>false</c>.</returns>
        ...
        public override void CompileTimeInitialize(LocationInfo targetLocation, AspectInfo aspectInfo)
        {
            ...
            this.name = targetLocation.DeclaringType.FullName + "." + targetLocation.Name;
        }
